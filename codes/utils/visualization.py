# Script to visualize and make cool plots
# Plotting functions
...
def prepare_data(df, dataset):
    """
    Prepare dataset for creating cool plots
    :param df:
    :param dataset:
    :return:
    """
...
def plot_runs_policy_models(datas, models, model_names, ep, policy='learned', mode='test', header='', save_fl_name=''):
    """
    Plot Systematic Generalization experiments
    :param datas:
    :param models:
    :param model_names:
    :param ep:
...
def plot_gen(data, model, max_rel=10, header='',save_fl_name=''):
    """
    Plot Systematic Generalization within training
    :param data:
    :param model:
    :param max_rel:
    :param header:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dfile',type=str, default='', help='Enter file which contains the raw logs')
    parser.add_argument('--dataset', type=str, default='', help='Enter the dataset name')
    parser.add_argument('--models', type=str, default='', help='Enter the model name')
    parser.add_argument('--model_legends', type=str, default='', help='Enter the model legends')
    parser.add_argument('--epoch', type=int, default=100, help='Epoch')
    parser.add_argument('--policy', type=str, default='fixed', help='Embedding policy')
    parser.add_argument('--header', type=str, default='', help='Header')
    parser.add_argument('--save_file', type=str, default='plot.png', help='file to save')
